...
def run():
    ...
    fj = plane.PLANE(screen, map_lenth, "stub", pygame.image.load('img/img;tech/phantom_35.png').convert_alpha(), 50, 5, 250, [480, 100, 50], [0, 0, 0], 1000)
    ...
    def generate_vehs(dct):
        ...
        return new
    vehicles_dct = {"AA":10, "LT": 5, "T":0, "ART": 60}
    vehicles = generate_vehs(vehicles_dct)
    map1 = background.Map(map_lenth, width, vehicles, env, 10)
