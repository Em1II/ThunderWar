...
def run():
    ...
    fj = plane.PLANE(screen, map_lenth, "stub", pygame.image.load('img/img;tech/phantom_35.png').convert_alpha(), 50, 5, 250, [0, 0, 0], [240, 100, 100], 1000)
    ...
    map1 = background.Map(map_lenth, width, vehicles, env, 5)
