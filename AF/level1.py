...
def run():
    ...
    fj = plane.PLANE(screen, map_lenth, "stub", pygame.image.load('img/img;tech/su-27_15.png').convert_alpha(), 70, 3, 200, [120, 100, 100], [40, 500, 1000], 300)
    ...
    def generate_vehs(dct):
        ...
        return new
    vehicles_dct = {"AA":2, "LT": 20, "T":10, "ART": 1}
    vehicles = generate_vehs(vehicles_dct)
    map1 = background.Map(map_lenth, width, vehicles, env, 0)
    ...
    while True:
        ...
        background.SHOW_TEXT(10, 110, f'Осталось {len(vehicles) - q} врагов', screen, 20)
        ...
        fj.plane_draw()
        animations.create_rocket_trail((-1000, -1000), abs_shift)
