...
def run():
    ...
    fj = plane.PLANE(screen, map_lenth, "stub", pygame.image.load('img/img;tech/f-16.png').convert_alpha(), 100, 3, 1000, [100, 100, 250], [10, 1000, 2000], 150)
    ...
    def generate_vehs(dct):
        ...
        return new
    vehicles_dct = {"AA":70, "LT": 6, "T":0, "ART": 0}
    vehicles = generate_vehs(vehicles_dct)
    map1 = background.Map(50000, width, vehicles, env, 2)
