...
def run():
    ...
    fj = plane.PLANE(screen, map_lenth, "stub", pygame.image.load('img/img;tech/su-27_15.png').convert_alpha(), 70, 3, 200, [40, 100, 100], [100, 500, 1000], 300)
    ...
    def generate_vehs(dct):
        ...
        return new
    vehicles_dct = {"AA":10, "LT": 22, "T":12, "ART": 7}
