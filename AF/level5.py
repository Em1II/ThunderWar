...
def run():
    ...
    fj = plane.PLANE(screen, map_lenth, "stub", pygame.image.load('img/img;tech/phantom_35.png').convert_alpha(), 50, 5, 250, [480, 100, 50], [120, 1000, 400], 1000)
    ...
    def generate_vehs(dct):
        ...
        return new
    vehicles_dct = {"AA":2, "LT": 5, "T":0, "ART": 40}
